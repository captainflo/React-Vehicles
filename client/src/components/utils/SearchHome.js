        ...
        <form className='search-city' id="search-form">
          <div className="row">
            <div className="col m12 s12">
                ...
                <button style={{marginTop: '32px'}} onClick={this.onSubmit} className="waves-effect waves-light btn btn-color btn-search right">Search</button>
...
export default compose(withRouter,connect(mapStateToProps, actions))(SearchHome);
